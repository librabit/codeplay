...
#배경 생성
bg = pygame.image.load("pygame_shooting/source/bg.png")

#캐릭터 생성
character = pygame.image.load("pygame_shooting/source/character.png")
...
#적군 생성
enemy = pygame.image.load("pygame_shooting/source/enemy.png")
...
#총알 생성
bullet = pygame.image.load("pygame_shooting/source/bullet.png")
bullet_size = bullet.get_rect().size
bullet_width = bullet_size[0]
bullet_height = bullet_size[1]
bullet_xPos = character_width / 2 - bullet_width / 2
bullet_yPos = character_height
